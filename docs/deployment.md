...
URL: `https://gioielleria.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `gioielleria.demo.federicocalo.dev`
...
- Output directory: `dist/gioielleria/browser`
...
URL: `https://fedcal.github.io/federico-demo-gioielleria/`
...
- `base: /federico-demo-gioielleria/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `gioielleria-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   gioielleria-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `gioielleria-docs.federicocalo.dev`
