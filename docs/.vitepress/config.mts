...
const SLUG = 'gioielleria';
const TITLE = 'Demo Gioielleria — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Gioielleria.',
  base: `/demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Gioielleria',
